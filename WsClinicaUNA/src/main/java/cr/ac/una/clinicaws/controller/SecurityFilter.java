...
public class SecurityFilter implements ContainerRequestFilter {
    ...
    //metodo que quiero excluir
    private static final String AUTHORIZATION_SERVICE_PATH = "validateUser";
    private static final String RENEWAL_SERVICE_PATH = "renovarToken";
    //el Bearer_ va en el header
    private static final String AUTHENTICATION_SCHEME = "Bearer ";
    //instanci del admin de token
    ...
    public void filter(ContainerRequestContext request) throws IOException {
        ...
        //revisr la respuesta del header si es de autorizacion
        ...
        // Extract the token from the Authorization header and delete Beare_ to get realToken
