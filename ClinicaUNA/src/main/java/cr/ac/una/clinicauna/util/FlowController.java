...
import cr.ac.una.clinicauna.controller.Controller;
...
public class FlowController {
  ...
  public void goMain(String view ) {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("view/"+view+".fxml"), this.idioma)));
            this.mainStage.show();
    ...
    public void goViewInWindow(String viewName) {
        ...
        //stage.getIcons().add(new Image(App.class.getResourceAsStream("/cr/ac/una/clinicauna/resources/Usuario-48.png")));
